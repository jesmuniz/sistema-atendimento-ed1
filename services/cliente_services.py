...
from validacoes import validar_cliente, validar_atendente;
clientes = []
atendentes = []
...
def cadastrar_cliente():
    ...
    if not validar_cliente(id_cliente, nome_cliente, telefone_cliente):
        return
...
def cadastrar_atendente():
    ...
    if not validar_atendente(id_atendente, nome_atendente):
        return
